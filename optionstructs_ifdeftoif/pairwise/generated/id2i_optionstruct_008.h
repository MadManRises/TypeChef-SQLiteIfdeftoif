...
void id2i_init()  {
  ...
  (id2i.sqlite_omit_attach = 1);
  (id2i.config_lzma = 0);
  (id2i.config_feature_env_long_options = 0);
  (id2i.sqlite_enable_fts4_unicode61 = 1);
  (id2i.config_pmap = 0);
  ...
  (id2i.sqlite_enable_tree_explain = 1);
  (id2i.config_chown = 0);
  (id2i.config_feature_unexpand_long_options = 0);
  (id2i.sqlite_omit_pager_pragmas = 1);
  (id2i.config_kill = 0);
  ...
  (id2i.config_ls = 0);
  (id2i.config_cpio = 0);
  (id2i.sqlite_enable_memsys3 = 1);
  (id2i.config_desktop = 0);
  (id2i.config_xz = 0);
  (id2i.config_long_opts = 0);
  (id2i.sqlite_omit_autovacuum = 1);
