...
ACLOCAL = ${SHELL} /local/janker/dev/buildSQLite/cRefactor-SQLiteEvaluation/missing --run aclocal-1.11
AMTAR = $${TAR-tar}
AR = ar
AUTOCONF = ${SHELL} /local/janker/dev/buildSQLite/cRefactor-SQLiteEvaluation/missing --run autoconf
AUTOHEADER = ${SHELL} /local/janker/dev/buildSQLite/cRefactor-SQLiteEvaluation/missing --run autoheader
AUTOMAKE = ${SHELL} /local/janker/dev/buildSQLite/cRefactor-SQLiteEvaluation/missing --run automake-1.11
AWK = mawk
BUILD_CFLAGS = 
CC = gcc
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /local/janker/dev/buildSQLite/cRefactor-SQLiteEvaluation/missing --run makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
VERSION = 3.8.1
abs_builddir = /local/janker/dev/buildSQLite/cRefactor-SQLiteEvaluation
abs_srcdir = /local/janker/dev/buildSQLite/cRefactor-SQLiteEvaluation
abs_top_builddir = /local/janker/dev/buildSQLite/cRefactor-SQLiteEvaluation
abs_top_srcdir = /local/janker/dev/buildSQLite/cRefactor-SQLiteEvaluation
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /local/janker/dev/buildSQLite/cRefactor-SQLiteEvaluation/install-sh
