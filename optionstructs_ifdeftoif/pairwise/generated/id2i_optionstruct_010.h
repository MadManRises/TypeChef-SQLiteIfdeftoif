...
void id2i_init()  {
  ...
  (id2i.config_kill = 0);
  (id2i.sqlite_enable_expensive_assert = 1);
  ...
  (id2i.sqlite_omit_foreign_key = 1);
  ...
  (id2i.sqlite_omit_builtin_test = 1);
