...
p <- ggplot(csvData.m,aes(x=factor(0),Measurements)) + geom_boxplot() + theme(axis.title.y=element_blank(),axis.text.y=element_blank(),axis.ticks.y=element_blank()) + labs(y="Total number of\nmeasurements", x="Interaction degree") + coord_flip()# + scale_y_continuous(formatter='log10')
...
p <- ggplot(csvData.m,aes(x=factor(0),Time)) + geom_boxplot() + theme(axis.title.y=element_blank(),axis.text.y=element_blank(),axis.ticks.y=element_blank()) + labs(y="Run time (ms)", x="Interaction degree") + coord_flip()# + scale_y_continuous(formatter='log10')
...
p <- ggplot(csvData.m,aes(x=factor(0),OverheadPercent)) + geom_boxplot() + theme(axis.title.y=element_blank(),axis.text.y=element_blank(),axis.ticks.y=element_blank()) + labs(y="Proportion of overhead to remaining execution time", x="Interaction degree") + coord_flip() + scale_y_continuous(labels = percent)# + scale_y_continuous(formatter='log10')
...
p <- ggplot(csvData.m,aes(x=factor(0),SimPercent)) + geom_boxplot() + theme(axis.title.y=element_blank(),axis.text.y=element_blank(),axis.ticks.y=element_blank()) + labs(y="Percent error\nin run times", x="Interaction degree") + coord_flip() + scale_y_continuous(labels = percent) #+ ggtitle("Performance measurement vs simulator")
...
p <- ggplot(csvData.m,aes(x=factor(0),SimVarPercent)) + geom_boxplot() + theme(axis.title.y=element_blank(),axis.text.y=element_blank(),axis.ticks.y=element_blank()) + labs(y="Percent error\nin run times", x="Interaction degree") + coord_flip() + scale_y_continuous(labels = percent)#+ ggtitle("Simulator vs variant")# + scale_y_continuous(formatter='log10')
