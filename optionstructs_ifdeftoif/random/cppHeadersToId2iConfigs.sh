...
for c in ./optionstructs_ifdeftoif/random/generated/tmp/id2i_include*.config;
do
    ...
    mv ../ifdeftoif/id2i_optionstruct.h optionstructs_ifdeftoif/random/generated/id2i_optionstruct_$configID.h
    rm $c
done
rm -rf ../ifdeftoif/id2i_optionstruct.h optionstructs_ifdeftoif/random/generated/tmp
