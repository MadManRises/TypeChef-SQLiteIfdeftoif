#!/bin/bash
#SBATCH -o /scratch/schuetz/logs/perf-ft-%a.txt
...
/scratch/schuetz/TypeChef-SQLiteIfdeftoif/performance_featurewise.sh ${SLURM_ARRAY_TASK_ID}
