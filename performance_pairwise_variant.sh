...
if [ $1 -lt $TOTAL ]; then
    ...
    for config in $scratchDir/TypeChef-SQLiteIfdeftoif/optionstructs_ifdeftoif/pairwise/generated/Prod*.h; do
        ...
        then
            ...
            # Run normal binary
            LD_LIBRARY_PATH=. ./a.out > $resultDir/var_pr_$configID.txt 2>&1
